...
2. **Относительное время** — «позавчера» вместо «2026-06-28», если сегодня 30 июня. Вычислять разницу между системной датой и датой события.
...
> «Позавчера мы правили этот файл» → факт: frontmatter date = 2026-06-28, сегодня = 30 июня, разница = 2 дня.
> 
> «На этой неделе мы добавили auto-commit в процесс-файлы» → факт: комит был 30 июня (сегодня).
