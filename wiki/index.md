...
* [Ibexa DXP](entities/ibexa-dxp.md) — Page covering Ibexa DXP — entity information, architecture details, and usage patterns. — [dxp, commerce-cms, ecommerce-platform, symfony]
...
* [PHP](entities/php.md) — This page explores PHP — programming language created for web development. — [php, programming-language, web-development, server-side, rasmus-lerdorf] ([PHP] [PHP language])
...
* [EasyAdmin Bundle](concepts/easyadmin-bundle.md) — This page explores EasyAdmin Bundle as a key concept in our knowledge base. — [easyadmin-admin-ui, symfony-bundle, crud-generation]
...
* [Sonata Admin Bundle](concepts/sonata-admin-bundle.md) — This page explores Sonata Admin Bundle as a key concept in our knowledge base. — [sonata-admin-ui, content-management-bundle, symfony-bundle]
* [Symfony AI Component](concepts/symfony-ai.md) — This page explores Symfony AI Component as a key concept in our knowledge base. — [llm-integration, symfony-ai, rag-patterns, embedding-vector]
...
* [Сравнение: Loomana (Markdown-driven wiki) vs pi-llm-wiki/ (TypeScript platform)](comparisons/llm-wiki-implementations.md) — Comparative analysis covering Сравнение: Loomana (Markdown-driven wiki) vs pi-llm-wiki/ (TypeScript platform) across different contexts and implementations. — [llm-wiki-patterns, wiki-implementations, compounding-knowledge]
...
---
*Created: auto-generated | Last updated: 2026-07-06 07:04*
