...
**Schema Reference**: `AGENTS.md#search_priority` → Details in [process-query.json](process-query.json).
...
**Schema Reference**: `AGENTS.md#contradiction_resolution` -> Full flow defined in [process-query.json](process-query.json). Applies to Query synthesis step.
